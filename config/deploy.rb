...
on :load do
  ...
  set :copy_exclude, [".git/*", ".bundle/*", "log/*", ".rvmrc", ".rbenv-version", "ops"]
  set :assets_role, [:app]
end
...
set :push_instance_config, Rubber.env != 'vagrant'

# don't waste time bundling gems that don't need to be there
set :bundle_without, [:development, :test, :staging] if Rubber.env == 'vagrant'
